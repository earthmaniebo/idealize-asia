 ...
 <head>
   ...
   <?php wp_head(); ?>
	...
	<center>
		<div class="container">
			<div class="row">
				<img src="wp-content/themes/wpbootstrap/img/landing.png" class="landing_img" />
			</div>
			<div class="row msg">
			...
			<a href="?page_id=7"><button type="button" class="btn"><div class="msgBtn">Proceed to the Website</div></button></a>
			</div>
